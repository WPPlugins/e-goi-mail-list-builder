=== Plugin Name ===
Contributors: shut1x, Delfim Carvalhosa, bzca
...
e-goi Mail List Builder is a simple plugin to integrate e-goi API with WordPress, making it easier to manage your newsletter subscriptions. This can easily be managed with a widget or with the comment section.
...
9. **Widget** - Widget set up screen.

== Changelog ==

= 1.0.8 =
* Final Fixes and WP 4.3.1 ready.
...
= 1.0.4 =
* Fixed checkbox bug
* Fixed comment subscription bug
* Added widget style edit
* Added Import
* Fixed several bugs
